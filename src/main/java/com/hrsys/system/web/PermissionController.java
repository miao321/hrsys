...
public class PermissionController {
	...
	public @ResponseBody ExtAjaxResponse saveOrUpdate(Permission permission) {
		...
		if (permissionService.findUrl(permission.getUrl()) != null) {
	...
	@SysControllerLog(module="用户权限分配",methods="保存或者更新数据")
	public @ResponseBody ExtAjaxResponse saveOr(Permission permission) {
		try {
			permissionService.saveOrUpdate(permission);		   
			return new ExtAjaxResponse(true, "操作成功");
		} catch (Exception e) {
	...
	@RequiresRoles("管理员")
	public @ResponseBody ExtAjaxResponse save(PermissionQueryDTO permissionQueryDTO,@RequestParam String roleName) {
	...
	@RequiresPermissions("permission/deletePermissions")
	@RequiresRoles("管理员")
